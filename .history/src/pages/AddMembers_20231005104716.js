        ...
        min="1997-01-01" max="2030-12-31"> */}
              ...
              <div className="row">
                <div className="mb-3 col">
                  ...
                  <select class="form-select" aria-label="Default select example" onChange={(e) => onInputChange(e)} value={user.id_type} required>
                ...
                <div className="mb-3 col">
                  ...
                  <select class="form-select" aria-label="Default select example" onChange={(e) => onInputChange(e)} value={user.gender} required>
                    ...
                    <option name="id_number" value="Aadhar Number">Male</option>
                    <option name="id_number" value="PAN Number">Female</option>
                    <option name="id_number" value="Passport Number">Others</option>
                  </select>
                </div>
              </div>
            </div>
