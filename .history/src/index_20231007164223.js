...
import SilverPlan from './components/Cards/Plan'
  ...
  <BrowserRouter>
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route exact path="/silver" element={<Plan />} />
        <Route exact path="/gold" element={<Plan />} />
        <Route exact path="/platinum" element={<Plan />} />
